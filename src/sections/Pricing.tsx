            ...
            return (
              <div key={`pricing-plan-${index}`} className={twMerge("card", tier.inverse == true && 'border-black bg-black text-white')}>
                <div className="flex justify-between">
                  ...
                  {
                    tier.popular == true && <div className="inline-flex text-sm px-4 py-1.5 rounded-xl border border-white/20"><motion.span className="bg-[linear-gradient(to_right,#DD7DDF,#E1CD86,#BBCB92,#71C2EF,#3BFFFF,#DD7DDF,#E1CD86,#BBCB92,#71C2EF,#3BFFFF)] [background-size:200%] text-transparent bg-clip-text font-medium"
                      animate={{
                ...
                <ul className="flex flex-col gap-5 mt-8">
                  {tier.features.map((feature) => {
                    return (
                      <li className="text-sm flex items-center gap-4" key={`feature-item-${index}`}>
