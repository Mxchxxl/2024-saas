    ...
    <div className="container  ">
      <div className="md:flex items-center">
        ...
        <div className="mt-20 md:mt-0 md:h-[648px] md:flex-1 relative">
          ...
          <motion.img src={CylinderImage.src} alt="cylinder image" width={220} height={220} className="hidden md:block -top-8 -left-32 md:absolute" style={{ translateY: translateY }} />

          <motion.img src={NoodleImage.src} alt="noodle image" width={220} className="hidden lg:block md:absolute top-[524px] left-[448px] rotate-[30deg]" style={{ rotate: 30, translateY: translateY }} />
