                        ...
                        props.testimonials.map((testimonial, index) => (
                            <div key={`testimonial${index}`} className="card">
                                ...
                                <div className="flex items-center gap-2 mt-5">
                                    <Image src={testimonial.imageSrc} alt="user image" width={40} height={40} className="rounded-full" />
    ...
    return <section className="bg-white py-0">
        <div className="container">
            ...
            <div className="flex justify-center gap-6 mt-10 [mask-image:linear-gradient(to_bottom,transparent,black_25%,black_75%,transparent)] max-h-[738px] overflow-hidden">
                ...
                <TestimonialsColumn testimonials={thridCol} duration={17} className="hidden lg:block" />
            </div>
        </div>
    </section>;
};
